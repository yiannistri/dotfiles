...
code --user-data-dir /home/$TARGET_USER/.config/Code/ --install-extension MS-vsliveshare.vsliveshare-pack
code --user-data-dir /home/$TARGET_USER/.config/Code/ --install-extension foam.foam-vscode
